...
import { Check, Loader2, SendHorizontal, X, Download } from "lucide-react"
...
const SlideButton = forwardRef<HTMLButtonElement, SlideButtonProps>(
    ({ className, onSlideSuccess, ...props }, ref) => {
        ...
        return (
            <motion.div
                ...
                className="shadow-button-inset dark:shadow-button-inset-dark relative flex h-9 items-center justify-center rounded-full bg-gray-100 dark:bg-zinc-800"
            >
                {!completed && (
                    <motion.div
                        style={{
                        ...
                        className="absolute inset-y-0 left-0 z-0 rounded-full bg-accent dark:bg-white"
                    />
                )}
                    ...
                    {!completed && (
                        ...
                        >
                            <Button
                                ...
                                size="icon"
                                className={cn(
                                    "shadow-button rounded-full drop-shadow-xl z-20",
                ...
                {!completed && (
                    <span className="absolute text-xs font-semibold uppercase tracking-wider text-black/50 dark:text-white/50 pointer-events-none z-0 ml-8">
                        Slide to Install
                    </span>
                )}
